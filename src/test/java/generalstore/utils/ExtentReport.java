...
public class ExtentReport {
    public static ExtentReports extent; //asagida kullanmak icin class seviyesine yazdik ve public static yaptik
    ...
    public static void raporOlustur(){
        ...
        extent.setSystemInfo("Tester", "Tuba Bagriyanik");
    }
    ...
    public static void raporuKaydet(){
        ...
        extent.flush(); //rapor olusturma metodu bu, mutlaka olmali
    }
}
